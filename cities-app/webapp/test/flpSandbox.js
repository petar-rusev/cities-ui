		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Cities Data",
									"targetURL": "#comsapcitiesapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapcitiesapp-display": {
								"semanticObject": "comsapcitiesapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.citiesapp",
									"url": sap.ui.require.toUrl("com/sap/citiesapp")
								}
							}
						}
					}
